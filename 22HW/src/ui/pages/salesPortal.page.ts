...
export abstract class SalesPortalPage extends BasePage {
  ...
  readonly ["Close Notification Button"] = (text: string) => `//div[div[contains(text(),'${text}')]]/button`;
  ...
  async closeNotificationByText(text: string) {
    await $(this["Close Notification Button"](text)).click();
  }
