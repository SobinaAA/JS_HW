...
import { Metric, Shedule } from "../../data/types/home.types";
...
export class HomePageService {
  ...
  async checkSheduleLayout(sheduleName: Shedule) {
    const container = this.homePage.getSheduleContainer(sheduleName);
    await expect(container).toHaveScreenshot();
  }
